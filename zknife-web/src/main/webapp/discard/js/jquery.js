...
jQuery.extend({
	...
	// Note: this method belongs to the css models but it's needed here for the support models.
	// If support gets modularized, this method should be moved back to the css models.
...
if ( typeof module === "object" && module && typeof module.exports === "object" ) {
	// Expose jQuery as models.exports in loaders that implement the Node
	// models pattern (including browserify). Do not create the global, since
	// the user will be storing it themselves locally, and globals are frowned
	// upon in the Node models world.
